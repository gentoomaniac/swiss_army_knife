...
def sniff_arp_requests():
    ...
    while RUN:
        ...
        LOGGER.info("[new][%s]\t eth_src_mac: %s\tsrc_ip: %s\tsrc_mac: %s\tdest_ip: %s\tdest_mac: %s" % (opcode, eth_src_mac, src_ip, src_mac, dest_ip, dest_mac))
